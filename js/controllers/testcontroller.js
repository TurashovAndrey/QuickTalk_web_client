angular.module("leasingApp",["categoriesModule", "requestsModule", "advertsModule", "usersModule"])
.controller("TestController", function(CategoriesService,RequestsService,AdvertsService,UsersService, $scope) {
   ...
   AdvertsService.get_advert("62a9d59a-4498-412f-9595-a5190433b9d4").then(function(data) {
      $scope.advert = data;
   });
})
